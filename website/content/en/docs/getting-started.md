...
description: "Install ImmyGo and build your first app"
weight: 1
---
...
See the [AI Integration Guide](../ai/#provider-setup) for full provider setup instructions.
...
See the [AI Integration Guide](../ai/) for full details on all AI developer features.

## Next Steps

- [Widgets Reference](../widgets/) — All controls with declarative and lower-level examples
- [Layouts Guide](../layouts/) — Composition patterns for both API levels
- [Theming Guide](../theming/) — Customizing colors, typography, runtime theme switching
- [AI Integration](../ai/) — AI capabilities, MCP server, dev tools, prototyping, and debugging
